...
import { createNewChat, getAllChats, getMessageByChat, sendMessage } from "../controller/chat.controller.js";
...
router.route("/message/:chatId").get(isAuth,getMessageByChat)
